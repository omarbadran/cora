            ...
            <tr class="edd-client-row notice-warning notice-alt" style="display: none">
                <td colspan="3">
                    <div class="edd-client-row">
                        <input class="edd-client-license-key" placeholder="Enter Your License" type="text" style="line-height: 28px;margin-right:-14px; border-top-right-radius:0px; border-bottom-right-radius:0px; border-right:0px;" value="<?php echo $this->plugin['license'] ?>"/>
                        ...
                        <button class="button edd-client-button" data-action=<?php echo $this->plugin['machine_name'].'-edd-client-operations'?> data-operation="check_expiry" data-nonce="<?php echo wp_create_nonce( $this->plugin['machine_name'].'-edd-client-operations' ) ?>"> <span class="dashicons dashicons-clock"></span> Check Expiry Date</button>
            ...
            switch($operation){
                case 'activate_license':
                    ...
                    if( $license_data->license === 'valid' ) {
                        ...
                        wp_send_json_error('Error, either incorrect key or maximum activation times reached.');
                    }
